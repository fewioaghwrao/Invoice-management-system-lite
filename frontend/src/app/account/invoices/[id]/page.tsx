...
<div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
  ...
  <a
    ...
    target="_blank"
    rel="noreferrer"
    className="inline-flex w-full sm:w-auto items-center justify-center rounded-lg border border-slate-700 bg-slate-950/30 px-3 py-2 text-xs font-semibold text-slate-200 hover:text-white"
  >
    📄 PDF表示
  </a>
</div>
